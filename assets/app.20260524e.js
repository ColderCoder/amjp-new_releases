...
function render() {
  ...
  elements.pageTitle.textContent = payload.sectionTitle || "Recent Releases";
  elements.sectionLabel.textContent = payload.storefront ? `Apple Music ${payload.storefront.toUpperCase()}` : "Apple Music JP";
  elements.jsonLink.href = dataUrl;
  elements.sourceLink.href = payload.source || "https://music.apple.com/jp/new?l=en";
  renderDate(payload.generatedAt);
...
function renderDate(value) {
  ...
  elements.generatedAt.dateTime = date.toISOString();
  elements.generatedAt.textContent = dateTimeFormatter.format(date);
}
